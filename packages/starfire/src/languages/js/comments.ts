...
export const addBlockStatementFirstComment = (node, comment) => {
...
export const addBlockOrNotComment = (node, comment) => {
...
//     ...
//   }
const handleIfStatementComments = (
  text,
  precedingNode,
  enclosingNode,
  followingNode,
...
const handleTryStatementComments = (
  enclosingNode,
  precedingNode,
  followingNode,
  comment
...
const handleMemberExpressionComments = (enclosingNode, followingNode, comment) => {
  if(
    enclosingNode &&
...
const handleConditionalExpressionComments = (
  enclosingNode,
  precedingNode,
  followingNode,
  comment,
...
const handleObjectPropertyAssignment = (enclosingNode, precedingNode, comment) => {
  if(
    enclosingNode &&
...
const handleMethodNameComments = (
  text,
  enclosingNode,
  precedingNode,
  comment,
...
const handleFunctionNameComments = (
  text,
  enclosingNode,
  precedingNode,
  comment,
...
const handleCommentAfterArrowParams = (text, enclosingNode, comment, options) => {
...
const handleCommentInEmptyParens = (text, enclosingNode, comment, options) => {
  if(
    privateUtil.getNextNonSpaceNonCommentCharacter(
      text,
      comment,
...
const handleLastFunctionArgComments = (
  text,
  precedingNode,
  enclosingNode,
  followingNode,
...
const handleImportSpecifierComments = (enclosingNode, comment) => {
...
const handleLabeledStatementComments = (enclosingNode, comment) => {
...
const handleBreakAndContinueStatementComments = (enclosingNode, comment) => {
  if(
    enclosingNode &&
...
const handleCallExpressionComments = (precedingNode, enclosingNode, comment) => {
  if(
    enclosingNode &&
    (enclosingNode.type === 'CallExpression' ||
      enclosingNode.type === 'OptionalCallExpression') &&
...
const handlePropertyComments = (enclosingNode, comment) => {
  if(
    enclosingNode &&
    (enclosingNode.type === 'Property' ||
      enclosingNode.type === 'ObjectProperty')
...
const handleOnlyComments = (enclosingNode, ast, comment, isLastComment) => {
...
const handleForComments = (enclosingNode, precedingNode, comment) => {
  if(
    enclosingNode &&
...
const handleImportDeclarationComments = (
  text,
  enclosingNode,
  precedingNode,
  comment,
...
const handleAssignmentPatternComments = (enclosingNode, comment) => {
...
const handleTypeAliasComments = (enclosingNode, followingNode, comment) => {
...
const handleVariableDeclaratorComments = (
  enclosingNode,
  followingNode,
  comment
) => {
...
const handleTSMappedTypeComments = (
  text,
  enclosingNode,
  precedingNode,
  followingNode,
...
export const isBlockComment = (comment) => comment.type === 'Block' || comment.type === 'CommentBlock';

export const hasLeadingComment = (node, fn: any = () => true) => {
...
export const handleRemainingComment = (comment, text, options, ast, isLastComment) => {
...
export const handleOwnLineComment = (comment, text, options, ast, isLastComment) => {
  const {precedingNode, enclosingNode, followingNode} = comment;
  if(
...
export const handleEndOfLineComment = (comment, text, options, ast, isLastComment) => {
  const {precedingNode, enclosingNode, followingNode} = comment;
  if(
    handleLastFunctionArgComments(
      text,
